...
#[must_use] pub fn detect_install_type(exe: &Path) -> Option<Branch> {
...
#[must_use] pub fn detect_install(exe: &Path) -> Option<InstallInfo> {
...
#[must_use] pub fn get_download_dir() -> PathBuf {
